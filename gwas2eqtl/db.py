...
class coloc(Base):
   ...
   __tablename__ = "coloc"
   __table_args__ = (UniqueConstraint('chrom', 'pos', 'gwas_id', 'eqtl_id', name='_coloc_uc'),)
   ...
   gwas_id = Column('gwas_id', String(63), nullable=False)
   eqtl_pval = Column('eqtl_pval', Float, nullable=False)
   eqtl_beta = Column('eqtl_beta', Float, nullable=False)
   eqtl_id = Column('eqtl_id', String(63), nullable=False)
