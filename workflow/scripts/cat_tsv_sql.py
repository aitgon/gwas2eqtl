...
#%%
columns = ("chrom", "pos", "rsid", "ref", "alt", "egene", "eqtl_beta", "eqtl_pvalue", "eqtl_identifier", "gwas_beta", "gwas_pvalue", "gwas_identifier", "pp_h4", "PP.H4.abf", "coloc_window", "nsnps", "PP.H3.abf", "PP.H2.abf", "PP.H1.abf", "PP.H0.abf")
coloc_df = pandas.DataFrame.from_records(coloc_line_lst, columns=columns)
Logger.info("coloc_df.shape[0]: " + str(coloc_df.shape[0]))

#%%
columns = ['chrom', 'pos', 'rsid', 'ref', 'alt', 'egene', 'egene_symbol', 'eqtl_beta', 'eqtl_pvalue', 'eqtl_identifier', 'gwas_beta', 'gwas_pvalue', 'gwas_identifier', 'pp_h4', 'PP.H4.abf', 'coloc_window', 'nsnps', 'PP.H3.abf', 'PP.H2.abf', 'PP.H1.abf', 'PP.H0.abf']
if coloc_df.shape[0] > 0:
    ...
    columns_numeric = ['pos', 'eqtl_beta', 'eqtl_pvalue', 'gwas_beta', 'gwas_pvalue', 'pp_h4', 'PP.H4.abf', 'PP.H3.abf', 'PP.H2.abf', 'PP.H1.abf', 'PP.H0.abf']
    coloc_df[columns_numeric] = coloc_df[columns_numeric].apply(pandas.to_numeric)
